...
- [Cutover] deploy.yml is now workflow_dispatch-ONLY (05-05 incident fix) — the go-live cutover must revert it to `on: push` for the production branch, otherwise bot publishes will not rebuild the live site.
